  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<PackagesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PackagesRecord> ordersPagePackagesRecordList = snapshot.data!;
                            ...
                            tabs: [
                              ...
                              StreamBuilder<List<PackagesRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<PackagesRecord> tabPackagesRecordList =
                                      snapshot.data!;
                                  return Tab(
                                    text: 'Packed',
                                    icon: Icon(
                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Builder(
                                            builder: (context) {
                                              final orderByItem = functions
                                                  .newCustomFunction2(
                                                      ordersPagePackagesRecordList
                                                          .toList())
                                                  .toList();
                                              return Column(
                                                mainAxisSize: MainAxisSize.max,
                                        ...
                                        child: Builder(
                                          builder: (context) {
                                            ...
                                            return ListView.builder(
                                              ...
                                              shrinkWrap: true,
                                              scrollDirection: Axis.vertical,
                                              itemCount: orderByPackages.length,
                                              itemBuilder: (context,
                                                  orderByPackagesIndex) {
                                                final orderByPackagesItem =
                                                    orderByPackages[
                                                        orderByPackagesIndex];
                                                return Padding(
                                                  padding: EdgeInsetsDirectional
                                                            ...
                                                            children: [
                                                              ...
                                                              Padding(
                                                                ...
                                                                child: Text(
                                                                  valueOrDefault<
                                                                      String>(
                                                                    '${orderByPackagesItem.quantity.toString()}  ${orderByPackagesItem.unit}',
                                                                    '0',
                                                                  ),
                                                                  style: FlutterFlowTheme.of(
                                                                          context)
